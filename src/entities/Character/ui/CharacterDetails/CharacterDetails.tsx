...
import { Image, Input, Form, Button, Typography, Breadcrumb, Skeleton, type FormInstance } from 'antd'
                    ...
                    {isLoading
                      ...
                      : (
                            <Input
                                ...
                                readOnly={!isEditable}
                                onChange={(event) => {
                                  dispatch(onCharacterEdit(event))
                                }}
                            />
                        )}
                </Item>
        ...
        <div className={classNames(cls.characterDetails, [className])}>
            ...
            <div className={classNames(cls.infoWrapper)}>
                ...
                <div className={classNames(cls.characterInfo)}>
                    <Title code={true} level={2}>{character?.name}</Title>
                    {(character != null) && (
                        <Form
                            size="small"
                            ref={formRef}
